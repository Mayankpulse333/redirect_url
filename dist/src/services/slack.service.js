...
class SlackService {
    ...
    getAuthUrl() {
        ...
        return `https://slack.com/oauth/v2/authorize?client_id=${config_1.config.slack.clientId}&scope=${scopes}&user_scope=email&redirect_uri=${config_1.config.slack.redirectUri}&state=${state}`;
    }
    /**
